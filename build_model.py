...
from .models.model import ESANet
from .models.model_one_modality import ESANetOneModality
from .models.model_skip_mod import SkipESANet
from .models.model_skip_mod_globalgate import SkipGateESANet
...
def build_model(args, n_classes):
    ...
    if args.pretrained_scenenet != '':
        ...
        checkpoint = torch.load(args.pretrained_scenenet, map_location=torch.device('cpu'))
    ...
    if args.finetune is not None:
        ...
        checkpoint = torch.load(args.finetune, map_location=torch.device('cpu'))
